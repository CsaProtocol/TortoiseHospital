...
-- Tartaruga 1
INSERT INTO turtle(center_id, tank_ID, turtle_sex, name, species) VALUES
('CTR0000001', 1, 'M', 'Terry', 'Caretta comune');

-- Tartaruga 2
INSERT INTO turtle(center_id, tank_ID, turtle_sex, name, species) VALUES
('CTR0000001', 2, 'F', 'Shelly', 'Testudo graeca');

-- Tartaruga 3
INSERT INTO turtle(center_id, tank_ID, turtle_sex, name, species) VALUES
('CTR0000001', 3, 'M', 'Massimo', 'Chrysemys picta');

-- Tartaruga 4
INSERT INTO turtle(center_id, tank_ID, turtle_sex, name, species) VALUES
('CTR0000002', 1, 'F', 'Aqua', 'Trachemys scripta');

-- Tartaruga 5
INSERT INTO turtle(center_id, tank_ID, turtle_sex, name, species) VALUES
('CTR0000002', 1, 'M', 'Sergio', 'Emys orbicularis');

-- Tartaruga 6
INSERT INTO turtle(center_id, tank_ID, turtle_sex, name, species) VALUES
('CTR0000001', 1, 'F', 'Tina', 'Kinosternon scorpioides');
